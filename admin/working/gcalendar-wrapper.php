...
$calColorBgDark      = '#FFEF9C';	// dark background color #FFEF9C
$calColorTextOnDark  = '#000000';	// text appearing on top of dark bg color #231F20
$calColorBgLight     = '#FFEF9C';	// light background color
