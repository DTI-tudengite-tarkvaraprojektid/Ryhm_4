...
<div class="row padding">
	<div class="about-1 col-12">
		...
		<form action="https://formspree.io/robert.shev.spam@gmail.com" method="POST" class="needs-validation" novalidate>
					...
					<input name="_next" value="http://greeny.cs.tlu.ee/~sevtrobe/Tantsumeka/Ryhm_4/main/eratunnid/seltskonnatants/" type="hidden">
					<input name="_subject" value="Registreerimine Seltskonnatants" type="hidden">
