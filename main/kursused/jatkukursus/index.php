...
<div class="row padding">
	<div class="about-1 col-12">
		...
		<form action="https://formspree.io/robert.shev.spam@gmail.com" method="POST" class="needs-validation" novalidate>
					...
					<div class="form-group">
						<textarea class="form-control" rows="14" name="sõnum" type="text" placeholder="Kirjutage millisel jätkukursusel soovite osaleda. Pärast registreerimist võtame Teiega ühendust." required></textarea>
					...
					<input name="_subject" value="Registreerimine jätkukursus" type="hidden">
